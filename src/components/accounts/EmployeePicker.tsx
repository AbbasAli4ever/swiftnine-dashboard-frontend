...
import { useEmployeeSearch } from "@/hooks/useAccounting";
import type { EmployeeSearchResult } from "@/services/accounting.service";

/**
 * Search-backed employee combobox, same shape as `ClientPicker`. Optional by
 * design — not every sale has an employee attached, so `value` can stay
 * `null` indefinitely.
 *
...
export default function EmployeePicker({
  ...
  const { results, isLoading } = useEmployeeSearch(term);
